        ...
        while True:
            ...
            if faces is not ():
                ...
                if len(face_imgs) > 0:
                    ...
                    # print(results[1],predicted_genders)
                   
                # draw results
                for i, face in enumerate(faces):
                    p_gender = "F" if predicted_genders[i][0] > 0.5 else "M"
                    label = "{}, {}".format(int(predicted_ages[i]),
                                            "F" if predicted_genders[i][0] > 0.5 else "M")
                    print(int(predicted_ages[i]),predicted_genders[i][0])
                    print("Age:", predicted_ages)
                    print("Genders:",p_gender)
                    ...
                    #if gender detected = M
                    if predicted_genders[i][0] < 0.5 and ((int(predicted_ages[i])>30) and (int(predicted_ages[i])<35)) :
                        print("Hello")
                        print("Age:", predicted_ages)
